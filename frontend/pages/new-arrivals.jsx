    ...
    const fetchProducts = async () => {
        try {
            ...
            if (res.ok) {
                ...
                // If no products have 'New' tag, maybe show all (recent) or clear filter?
                // Let's stick to logic: Filter 'New' by default. 
                // However, newly added products might not have 'New' tag explicitly set if user didn't type it?
                // The 'New Product' form has a 'Tag' field.
            }
        } catch (error) {
